...
public class InvariantDeviceProfile {
    ...
    InvariantDeviceProfile(Context context) {
        ...
        minWidthDps = LauncherIcons.dpiFromPx(Math.min(smallestSize.x, smallestSize.y), dm);
        minHeightDps = LauncherIcons.dpiFromPx(Math.min(largestSize.x, largestSize.y), dm);
        ...
        iconBitmapSize = LauncherIcons.pxFromDp(iconSize, dm);
        ...
        try (XmlResourceParser parser = context.getResources().getXml(R.xml.device_profiles)) {
            ...
            while (((type = parser.next()) != XmlPullParser.END_TAG ||
                ...
                if ((type == XmlPullParser.START_TAG) && "profile".equals(parser.getName())) {
                    ...
                    float iconSize = a.getFloat(R.styleable.InvariantDeviceProfile_customIconSize, 0);
